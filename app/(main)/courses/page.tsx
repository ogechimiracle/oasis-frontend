            ...
            <div className="px-8 lg:px-15">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between mt-10">
                    <h1 className="text-2xl font-bold text-black">
                        ...
                        <span className="text-2xl font-semibold text-myheroColor">({courses?.length || 0})</span>
                    </h1>
                    <div className="flex flex-wrap gap-x-5">
                        <div>
                            <input type="text" value={search} onChange={(e)=>setSearch(e.target.value)} placeholder="Search courses..." className="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-myprimaryColor"/>
                        </div>

                        <div>
                            <select name="" id="" value={category} onChange={(e)=>setCategory(e.target.value)} className="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-myprimaryColor mt-3 lg:mt-0 ">
                        ...
                        <div>
                            <select name="" id="" value={level} onChange={(e)=>{setLevel(e.target.value)}} className="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-myprimaryColor mt-3 lg:mt-0">
                ...
                <div className="mt-8 w-full">
                    ...
                    :
                    (
                        <div className="text-center font-semibold font-poppins text-myheroColor">No courses available</div>
                    )}
                        ...
                        <div className="mt-4 w-full px-4 pb-2">
                            ...
                            <div className="flex flex-col  space-y-2">
                                ...
                                <div className="flex flex-col">
                                    <span className="font-semibold text-black">Descriptions</span>
                                    <p className="text-sm text-gray-600">{selectedCourse.briefDefinition}</p>
                                </div>
                                 ...
                                 <div className="flex flex-col">
                                    ...
                                    <p className="text-sm text-gray-600">{selectedCourse.prerequisite}</p>
                                </div>

                                 <div className="flex flex-col">
                                    <span className="font-semibold text-black">Key Areas to Learn</span>
                                    <div className="text-sm text-gray-600">
                                        {selectedCourse.keyAreas?.map((area: string, index: number) => (
                                ...
                                <div className="flex flex-col">
                                    <span className="font-semibold text-black">What you'll do</span>
                                    <div className="text-sm text-gray-600">
                                ...
                                <div className="flex flex-col">
                                    <span className="font-semibold text-black">Job Roles</span>
                                    <div className="text-sm text-gray-600">
                                        {selectedCourse.jobRoles?.map((job: string, index: number) => (
                                ...
                                <div className="flex flex-col">
                                    <span className="font-semibold text-black">Industries Application</span>
                                    <div className="text-sm text-gray-600">
                                        {selectedCourse.industries?.map((industry: string, index: number) => (
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-sm text-gray-600">{formatCurrency(selectedCourse.cost)}</p>
                                </div>
